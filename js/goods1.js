...
var NAMES = ['Чесночные сливки', 'Огуречный педант', 'Молочная хрюша', 'Грибной шейк',
...
var PICTURES = ['img/cards/gum-cedar.jpg', 'img/cards/gum-chile.jpg', 'img/cards/gum-eggplant.jpg', 'img/cards/gum-mustard.jpg'];
...
var getContents = function () {
  var contents = '';
  for (var i = 0; i < randomInteger(1, CONTENTS.length - 1); i++) {
    if (i === 0) {
      contents = CONTENTS[randomInteger(0, CONTENTS.length - 1)];
    } else {
      contents = contents + ', ' + CONTENTS[randomInteger(0, CONTENTS.length - 1)];
    }
  }
  return contents;
};
...
var getCards = function () {
  ...
  var arr = {
    ...
    picture: PICTURES[randomInteger(0, PICTURES.length - 1)],
  ...
  if (nutritionFacts.sugar) {
    ...
    ardsElement.querySelector('.card__characteristic').textContent = 'Без сахара'
    ;}
